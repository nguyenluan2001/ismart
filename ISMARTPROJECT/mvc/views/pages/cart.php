                    ...
                    <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="" title="" class="thumb">
                                            <img src="<?php echo "admin/uploads/" . $item['product_thumb'] ?>" alt="">
                                        </a>
                                    </td>
                                    <td>
                                        <a href="?controller=Products&action=Detail_Product&id=<?php echo $item['id'] ?>" title="" class="name-product"><?php echo $item['product_desc'] ?></a>
                                    </td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="7">
                                    <div class="clearfix">
                                        <p id="total-price" class="fl-right">Tổng giá: <span><?php echo number_format($_SESSION['cart']['info']['total']) ?></span></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
