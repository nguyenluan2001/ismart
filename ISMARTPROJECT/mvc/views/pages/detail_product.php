                ...
                <div class="section-detail clearfix">
                    <div class="thumb-wp fl-left">
                        <a href="" title="" id="main-thumb">
                            <img id="zoom" width="200px" src="<?php echo "admin/uploads/".$data['product']['product_thumb']?>" data-zoom-image="<?php echo "admin/uploads/".$data['product']['product_thumb']?>"/>
                        </a>
                        <div id="list-thumb">
                    ...
                    <div class="info fl-right">
                        <h3 class="product-name"><?php echo $data['product']['product_desc']?></h3>
                        <div class="desc">
                        ...
                        <p class="price"><?php echo number_format($data['product']['price'])?></p>
                        <div id="num-order-wp">
                            <a title="" id="minus"><i class="fa fa-minus"></i></a>
                            <input type="text" name="num-order" value="1" id="num-order">
                            <a title="" id="plus"><i class="fa fa-plus"></i></a>
                        </div>
                        <a href="?controller=Cart&action=AddCart&id=<?php echo $data['product']['id']?>" title="Thêm giỏ hàng" class="add-cart">Thêm giỏ hàng</a>
                    </div>
                </div>
            </div>
