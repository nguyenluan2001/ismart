...
//            $(this).parent('li').find('.sub-menu').slideDown();
    ...
    $("input#num_order").change(function(){
        ...
        $.ajax({
            url:"?controller=Cart&action=UpdateCart_Ajax",
            method: "POST",
            data: data,
            dataType: 'json',
            success: function(data){
                $(this).val(data.qty);
                $("p#sub_total_"+id).text(data.sub_total);
   ...
   var src=$("#detail-blog-wp .section-detail img").attr('src');
   src="admin/"+src;
   $("#detail-blog-wp .section-detail img").attr('src',src);
});
