                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="tbody-thumb">
                                                <img src="<?php echo "uploads/Product/".$item['product_thumb']?>" alt="">
                                            </div>
                                        </td>
                                        <td class="clearfix">
                                            <div class="tb-title fl-left">
                                                <a href="?controller=Products&action=Update_Product&id=<?php echo $item['id']?>" title=""><?php echo $item['product_name']?></a>
                                            </div>
                                            <ul class="list-operation fl-right">
                                                ...
                                                <li><a href="?controller=Products&action=Delete_Product&id=<?php echo $item['id']?>&cat_id=<?php echo $item['cat_id']?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                            </ul>
                                        </td>
