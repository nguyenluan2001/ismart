                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="">Tất cả <span class="count">(<?php echo count($data['list_pages'])?>)</span></a> |</li>
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                <?php $count=1; foreach ($data['list_pages'] as $item) { ?>
                                    <tr>
                                        <td><input type="checkbox" name="checkItem" class="checkItem"></td>
                                        <td><span class="tbody-text"><?php echo $count;?></h3></span>
                                        <td class="clearfix">
                                            <div class="tb-title fl-left">
                                                <a href="?controller=Pages&action=Update_Page&id=<?php echo $item['id'] ?>" title=""><?php echo $item['page_title']?></a>
                                            </div>
                                            <ul class="list-operation fl-right">
                                                <li><a href="?controller=Pages&action=Update_Page&id=<?php echo $item['id'] ?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                <li><a href="?controller=Pages&action=Delete_Page&id=<?php echo $item['id'] ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                            </ul>
                                        </td>
