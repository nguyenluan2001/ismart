                ...
                <div class="section-detail">
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                <?php $count=1; foreach ($data['list_cats'] as $item) { ?>
                                    <tr>
                                        <td><input type="checkbox" name="checkItem" class="checkItem"></td>
                                        <td><span class="tbody-text"><?php echo $count?></h3></span>
                                        <td class="clearfix">
                                            <div class="tb-title fl-left">
                                                <a href="?controller=Posts&action=Detail_Cat&id=<?php echo $item['id']?>" title=""><?php echo $item['cat_title']?></a>
                                            </div>
                                        ...
                                        <td><span class="tbody-text"><?php echo $_SESSION['admin']['fullname']?></span></td>
