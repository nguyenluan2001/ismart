                                    ...
                                    <tr>
                                        ...
                                        <td class="clearfix">
                                            <div class="tb-title fl-left">
                                                <a href="?controller=Posts&action=Update_Post&id=<?php echo $item['id']?>" title=""><?php echo $item['post_title']?></a>
                                            </div>
                                            <ul class="list-operation fl-right">
                                                <li><a href="?controller=Posts&action=Update_Post&id=<?php echo $item['id']?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                <li><a href="?controller=Posts&action=Delete_Post&id=<?php echo $item['id']?>&cat_id=<?php echo $item['cat_id']?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                            </ul>
                                        </td>
                                        <td><span class="tbody-text"><?php echo $item['cat_title']?></span></td>
                                        <td><span class="tbody-text">Hoạt động</span></td>
                                        <td><span class="tbody-text"><?php echo $item['post_author']?></span></td>
