            ...
            <div id="container">
                <div id="header-wp">
                        ...
                        <div class="wp-inner">
                            ...
                            <div id="main-menu-wp" class="fl-right">
                                <ul id="main-menu" class="clearfix">
                                    ...
                                    <li>
                                        <a href="?controller=Pages&action=Index&id=1" title="">Giới thiệu</a>
                                    </li>
                                    <li>
                                        <a href="?controller=Pages&action=Index&id=2" title="">Liên hệ</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div id="head-body" class="clearfix">
                        <div class="wp-inner">
                            <a href="?controller=Home&action=Index" title="" id="logo" class="fl-left"><img src="public/images/logo.png"/></a>
                            <div id="search-wp" class="fl-left">
                                <form method="POST" action="?controller=Products&action=Search_Product">
                                    <input type="text" name="search_content" id="s" placeholder="Nhập từ khóa tìm kiếm tại đây!">
                            ...
                            <div id="action-wp" class="fl-right">
                                ...
                                <div id="cart-wp" class="fl-right">
                                    <div id="btn-cart">
                                        <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                                        <span id="num"><?php if(isset($_SESSION['cart']['info']['num_order'])){
  echo $_SESSION['cart']['info']['num_order'];
                                    ...
                                    <div id="dropdown">
                                        ...
                                        <dic class="action-cart clearfix">
                                            <a href="?controller=Cart&action=Show" title="Giỏ hàng" class="view-cart fl-left">Giỏ hàng</a>
                                            <a href="?controller=Cart&action=Check_Out" title="Thanh toán" class="checkout fl-right">Thanh toán</a>
                                        </dic>
                                    </div>
                                </div>
                            </div>
