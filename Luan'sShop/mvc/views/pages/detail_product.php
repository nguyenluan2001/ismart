        ...
        <div class="main-content fl-right">
                ...
                <div class="section-detail clearfix">
                    <div class="thumb-wp fl-left">
                        <a href="" title="" id="main-thumb">
                            <img id="zoom" width="200px" src="<?php echo "admin/uploads/Product/" . $data['product']['product_thumb'] ?>" data-zoom-image="<?php echo "admin/uploads/Product/" . $data['product']['product_thumb'] ?>" />
                        </a>
                        <div id="list-thumb">
                    ...
                    <div class="info fl-right">
                        <h3 class="product-name"><?php echo $data['product']['product_name'] ?></h3>
                        <div class="desc">
                            <p><?php echo $data['product']['product_desc'] ?></p>
                        ...
                        <form action="?controller=Cart&action=Add_Cart&id=<?php echo $data['product']['id'] ?>" method="POST">
                            <div id="num-order-wp">
                            ...
                            <!-- <a href="?controller=Cart&action=Add_Cart&id=<?php echo $data['product']['id'] ?>" title="Thêm giỏ hàng" class="add-cart">Thêm giỏ hàng</a> -->
                        </form>
            ...
            <div class="section" id="post-product-wp">
                ...
                <div class="section-detail">
                    <p><?php echo $data['product']['product_intro'] ?></p>
